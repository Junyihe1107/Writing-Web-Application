...
class Header extends Component {
  ...
  render(){
    const { focused, handleInputfocus, handleInputBlur, list, login, logout } = this.props;    //写了之后focused = this.props.focused
    return (
      <HeaderWrapper>
      <Link to = '/'>
        <Logo />
  ...
  return {
      ...
      handleChangePage(page, totalPage, spin){
        ...
        if(page < totalPage){
          ...
          dispatch(actionCreators.changePage(1, totalPage));
        }
      },
